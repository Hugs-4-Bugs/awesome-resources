...
public class DatabaseFileService {
    ...
    public DatabaseFile getFileByName(String fileName) {
        Optional<DatabaseFile> dbFile = dbFileRepository.findByFileName(fileName);
        return dbFile.orElseThrow(() -> new FileNotFoundException("File not found with name " + fileName));
    }
}
